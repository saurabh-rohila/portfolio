          ...
          <div className="space-y-3 animate-fade-in-up text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-2 justify-center">
              ...
              <button
                ...
                className="bg-white text-[#7662B2] border-2 border-[#7662B2] px-4 py-2 rounded-full font-bold transition-all duration-300 hover:bg-[#7662B2] hover:text-white hover:shadow-lg hover:scale-105 active:scale-95 inline-flex items-center justify-center space-x-1.5 text-sm"
              >
