          ...
          <div className="space-y-3 animate-fade-in-up text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 pt-2 justify-center">
              <a
                ...
                className="bg-[#25D366] text-white px-4 py-2 rounded-full font-semibold transition-all duration-300 hover:bg-[#1da851] hover:shadow-lg hover:scale-105 active:scale-95 inline-flex items-center justify-center space-x-2 text-xs"
              >
